    ...
    <div className="h-full flex flex-col glass border-r border-[var(--border-subtle)] overflow-hidden">
      ...
      <div className="p-4 border-b border-[var(--border-subtle)] flex-shrink-0">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="font-bold text-lg gradient-text">{t('logoTitle')}</h2>
            <p className="text-xs text-[var(--foreground-muted)]">{t('logoSubtitle')}</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden">
        ...
        <div className="px-3 pb-3 space-y-2">
          ...
          <button
            onClick={onAddAxis}
            className="w-full flex items-center justify-center gap-2 p-4 mt-2 text-sm font-medium text-[var(--primary-300)] bg-[var(--primary-500)]/5 border border-dashed border-[var(--primary-500)]/30 rounded-xl hover:bg-[var(--primary-500)]/10 hover:border-[var(--primary-500)]/50 transition-all duration-200 group"
          >
